...
<div id="bgselect">
    ...
    <form action="process_form.php" method="POST" id="dropbox">
        <select name="selecteam1" id="selecteam1" class="drop-target" ondragover="dragOver(event)" ondrop="drop(event)"></select>
        <select name="seleccentral" id="seleccentral" class="drop-target" ondragover="dragOver(event)" ondrop="drop(event)">
            <?php
        ...
        <select name="selecteam2" id="selecteam2" class="drop-target" ondragover="dragOver(event)" ondrop="drop(event)"></select>
    ...
    <?php
    include "./includes/process_form.php"
    ?>
</div>
